pdf("AOCF-svmaccuracy_6or1TW.pdf")
...
groupingby =  "AOCF" #"MITsoft" # other possibilities:

Npermutation = 60 # number of permutation to perform. set to 1 if testing (42 s per run with AOCF designation,30s with MIT)
